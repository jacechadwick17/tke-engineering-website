    ...
    >
      ...
      >
        <img
          ...
          alt="Construction worker operating industrial machinery"
      ...
      >
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            <span className="block">TKE Engineering</span>
            <span className="block text-[#2d8a7a]">& Design</span>
          </h1>
          ...
          >
            Precision engineering solutions for the gas and pipeline industry.
