        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
                  ...
                  >
                    <button
                      ...
                      className={`w-full flex items-center gap-4 py-3 px-4 rounded-lg transition-all duration-300 text-left ${
                        isHovered ? 'bg-[#00A0A0]/10' : 'bg-transparent'
                      }`}
                    >
                      <Icon
                        size={20}
                        className={`transition-colors duration-300 flex-shrink-0 ${
                          isHovered ? 'text-[#00A0A0]' : 'text-[#888888]'
                        }`}
                      />
                      <span
          ...
          <div ref={rightColRef} className="space-y-12">
            ...
            <div>
              ...
              <div className="h-1 w-20 bg-[#00A0A0] mb-6" />
            ...
            <div className="grid grid-cols-2 gap-6 pt-8 border-t border-white/10">
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-[#00A0A0]">
              ...
              {selectedServiceData && (
                <>
                  {(() => {
                    ...
                    return <Icon size={28} className="text-[#00A0A0]" />;
                  })()}
